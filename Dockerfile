...
RUN msbuild .\src\Application\Sitecore.Prototype\Sitecore.Prototype.Web\Sitecore.Prototype.Web.csproj /p:Configuration=$env:BUILD_CONFIGURATION /p:DeployOnBuild=True /p:DeployDefaultTarget=WebPublish /p:WebPublishMethod=FileSystem /p:PublishUrl=C:\out\website
...
# --from=builder C:\out\xconnect .\xconnect\